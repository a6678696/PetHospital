...
--
-- Host: localhost    Database: db_pethospital
-- ------------------------------------------------------
...
INSERT INTO `t_articletype` VALUES (1,'医院公告','医院公告'),(2,'医院新闻','医院新闻'),(3,'康复故事','康复故事'),(4,'宠物大全','宠物大全'),(5,'宠物饲养','宠物饲养'),(6,'宠物医疗','宠物医疗'),(7,'宠物训练','宠物训练');
...
--
-- Dumping data for table `t_assay`
--

LOCK TABLES `t_assay` WRITE;
/*!40000 ALTER TABLE `t_assay` DISABLE KEYS */;
INSERT INTO `t_assay` VALUES (4,'2022-05-13 03:07:50','傅丽','小r','111'),(5,'2022-05-13 03:08:11','傅丽','小r','32131');
/*!40000 ALTER TABLE `t_assay` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `t_carousel` VALUES (1,'20200125163059.jpg',1,'1',1),(2,'20200125162410.jpg',2,'1',1),(3,'20200125162501.jpg',3,'1',1),(4,'20200125164544.jpg',4,'1',1),(19,'20200125192437.jpg',5,'1',1),(20,'20200125220628.jpg',1,'2',2),(21,'20200125220635.jpg',2,'2',2),(22,'20200125220613.jpg',3,'2',2),(23,'20200125223719.jpg',4,'2',2);
...
INSERT INTO `t_comment` VALUES (15,37,96,'很棒','2022-05-12 23:34:11',30);
...
INSERT INTO `t_customer` VALUES (30,'吉林省白山市长白朝鲜族自治县十四道沟镇','蒋杰','LeDao宠物店','19525544875',NULL,'a1203007469','123456','20230225145612.jpg'),(31,'新疆维吾尔自治区塔城地区乌苏市兵团一二五团分部生活区','傅丽','无','18784866199',NULL,'823629263','6678696','20220513013511.jpg'),(32,'福建省泉州市洛江区虹山乡','朱晓庆','1','19897927056',NULL,'1203007469','123456','20221029140223.jpeg');
...
INSERT INTO `t_equipment` VALUES (1,'B超-彩色1号',1,0),(2,'手术心电及血氧监控1',2,0),(3,'生化分析仪1',3,0),(4,'高周波X线机1',7,0),(6,'B超-彩色2号',1,0),(9,'B超-彩色3号',1,0);
...
--
-- Dumping data for table `t_equipmentuselog`
--

LOCK TABLES `t_equipmentuselog` WRITE;
/*!40000 ALTER TABLE `t_equipmentuselog` DISABLE KEYS */;
/*!40000 ALTER TABLE `t_equipmentuselog` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `t_favorite` VALUES (286,31,1,'2022-05-13 04:54:49'),(287,31,2,'2022-05-13 04:54:50'),(288,31,3,'2022-05-13 04:54:52'),(289,31,4,'2022-05-13 04:55:09'),(291,30,5,'2022-10-29 13:35:46'),(293,30,34,'2022-10-29 14:12:07'),(294,30,6,'2023-02-25 15:00:16'),(295,30,45,'2023-02-25 15:01:29'),(296,30,40,'2023-02-25 15:01:31'),(297,30,31,'2023-02-25 15:03:26');
...
--
-- Dumping data for table `t_foster_care`
--

LOCK TABLES `t_foster_care` WRITE;
/*!40000 ALTER TABLE `t_foster_care` DISABLE KEYS */;
INSERT INTO `t_foster_care` VALUES (1,'2022-05-13 03:18:14','2022-05-17 03:18:16',31,59,300,0,'12312131'),(2,'2022-05-13 03:18:44','2022-05-16 03:18:47',31,59,211,1,'123131');
/*!40000 ALTER TABLE `t_foster_care` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `t_goodstype` VALUES (1,'icon-folderOpen','所有类别',-1,1),(21,'icon-folder','宠物交易',1,1),(22,'icon-folder','狗狗商品',1,1),(23,'icon-folder','猫咪商品',1,1),(24,'icon-folder','小宠商品',1,1),(25,'icon-folder','水族商品',1,1),(26,'icon-folder','萌宠周边',1,1),(33,'icon-folder','狗狗',21,0),(34,'icon-folder','猫咪',21,0),(36,'icon-folder','主粮零食',22,0),(37,'icon-folder','医疗保健',22,0),(38,'icon-folder','美容日用',22,0),(39,'icon-folder','出行',22,0),(40,'icon-folder','玩具',22,0),(41,'icon-folder','主粮零食',23,0),(42,'icon-folder','医疗保健',23,0),(43,'icon-folder','美容日用',23,0),(44,'icon-folder','出行',23,0),(45,'icon-folder','玩具',23,0),(46,'icon-folder','兔子商品',24,0),(47,'icon-folder','仓鼠商品',24,0),(48,'icon-folder','龙猫商品',24,0),(49,'icon-folder','其它',24,0),(50,'icon-folder','鱼食',25,0),(51,'icon-folder','鱼缸',25,0),(52,'icon-folder','其它',25,0),(53,'icon-folder','布艺',26,0),(54,'icon-folder','装饰',26,0),(55,'icon-folder','家具',26,0),(57,'icon-folder','其它',21,0);
...
INSERT INTO `t_goodsunit` VALUES (1,'个'),(2,'袋'),(3,'盒'),(4,'箱'),(5,'台'),(6,'包'),(11,'件'),(12,'条'),(16,'只');
...
INSERT INTO `t_inquiry` VALUES (1,'2022-05-13 02:02:09',30,3,'123','20220513020209.jpg',NULL,NULL,NULL,0),(2,'2022-05-13 04:35:52',31,59,'123131','20220513043552.jpg',NULL,NULL,NULL,0);
...
) ENGINE=InnoDB AUTO_INCREMENT=13531 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `t_log` VALUES (13497,'查询客户消息','2022-05-13 04:58:16','查询操作',1),(13498,'查询客户消息','2022-05-13 04:58:16','查询操作',1),(13499,'查询角色信息','2022-05-13 04:58:26','查询操作',1),(13500,'查询角色信息','2022-05-13 04:58:26','查询操作',1),(13501,'查询病历单','2022-05-13 05:02:20','查询操作',1),(13502,'查询化验记录','2022-05-13 05:02:22','查询操作',1),(13503,'查询疫苗注射记录','2022-05-13 05:02:23','查询操作',1),(13504,'查询客户回访记录','2022-05-13 05:02:24','查询操作',1),(13505,'查询寄养记录','2022-05-13 05:02:26','查询操作',1),(13506,'查询寄养记录','2022-05-13 05:02:36','查询操作',1),(13507,'查询客户回访记录','2022-05-13 05:02:37','查询操作',1),(13508,'查询疫苗注射记录','2022-05-13 05:02:38','查询操作',1),(13509,'查询化验记录','2022-05-13 05:02:40','查询操作',1),(13510,'查询病历单','2022-05-13 05:02:41','查询操作',1),(13511,'查询病历单','2022-05-13 05:02:56','查询操作',1),(13512,'查询化验记录','2022-05-13 05:02:57','查询操作',1),(13513,'查询疫苗注射记录','2022-05-13 05:02:59','查询操作',1),(13514,'查询客户回访记录','2022-05-13 05:03:00','查询操作',1),(13515,'查询寄养记录','2022-05-13 05:03:01','查询操作',1),(13516,'用户登录','2023-02-23 23:01:25','登录操作',1),(13517,'退货单查询','2023-02-23 23:01:28','查询操作',1),(13518,'客户退货单查询','2023-02-23 23:01:29','查询操作',1),(13519,'销售单查询','2023-02-23 23:01:29','查询操作',1),(13520,'查询病历单','2023-02-23 23:01:32','查询操作',1),(13521,'查询病历单','2023-02-23 23:01:32','查询操作',1),(13522,'查询化验记录','2023-02-23 23:01:33','查询操作',1),(13523,'查询化验记录','2023-02-23 23:01:33','查询操作',1),(13524,'查询客户回访记录','2023-02-23 23:01:34','查询操作',1),(13525,'查询客户回访记录','2023-02-23 23:01:34','查询操作',1),(13526,'用户登录','2023-02-25 15:04:21','登录操作',1),(13527,'查询角色信息','2023-02-25 15:04:25','查询操作',1),(13528,'查询角色信息','2023-02-25 15:04:25','查询操作',1),(13529,'查询用户信息','2023-02-25 15:04:25','查询操作',1),(13530,'查询用户信息','2023-02-25 15:04:25','查询操作',1);
...
--
-- Dumping data for table `t_medical_record`
--

LOCK TABLES `t_medical_record` WRITE;
/*!40000 ALTER TABLE `t_medical_record` DISABLE KEYS */;
INSERT INTO `t_medical_record` VALUES (1,'2022-05-13 04:11:43','傅丽','小r','21313'),(2,'2022-05-13 04:11:56','傅丽','小r','214141wqewqeq');
/*!40000 ALTER TABLE `t_medical_record` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `t_pet` VALUES (3,'小y','金毛',30,3,'20200202184514.jpg'),(59,'小r','猫咪',31,2,'20220513013734.jpg');
...
--
-- Dumping data for table `t_return_visit`
--

LOCK TABLES `t_return_visit` WRITE;
/*!40000 ALTER TABLE `t_return_visit` DISABLE KEYS */;
INSERT INTO `t_return_visit` VALUES (1,'2022-05-13 02:20:21','蒋杰','小y',3,'1231231'),(2,'2022-05-13 02:21:18','傅丽','小r',5,'1232131'),(3,'2022-05-13 02:27:45','傅丽','小r',5,'111');
/*!40000 ALTER TABLE `t_return_visit` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `t_role` VALUES (1,'系统管理员','管理员 最高权限'),(2,'主管','主管'),(4,'采购员','采购员'),(5,'销售经理','销售经理'),(7,'仓库管理员','仓库管理员'),(9,'总经理','总经理'),(10,'医生','医生'),(11,'美容师','美容师'),(12,'设备管理人员','设备管理人员'),(13,'测试','测试');
...
INSERT INTO `t_sale_list` VALUES (65,50,50,'123','2022-05-12 23:26:25','XS202205120001',5,30,1);
...
INSERT INTO `t_sale_list_goods` VALUES (96,'0034',37,'1.3kg','宝路Pedigree 肉类奶蔬菜幼犬粮 1.3kg',1,40,40,'包',65,36,1,0,0);
...
--
-- Dumping data for table `t_salelist_payment_information`
--

LOCK TABLES `t_salelist_payment_information` WRITE;
/*!40000 ALTER TABLE `t_salelist_payment_information` DISABLE KEYS */;
INSERT INTO `t_salelist_payment_information` VALUES (12,'XS202205120001',2,50,30,'2022-05-12 23:26:35');
/*!40000 ALTER TABLE `t_salelist_payment_information` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `t_tackle`
--

LOCK TABLES `t_tackle` WRITE;
/*!40000 ALTER TABLE `t_tackle` DISABLE KEYS */;
INSERT INTO `t_tackle` VALUES (3,'医院用品1',0),(4,'医院用品2',0);
/*!40000 ALTER TABLE `t_tackle` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `t_tackleoutlog`
--

LOCK TABLES `t_tackleoutlog` WRITE;
/*!40000 ALTER TABLE `t_tackleoutlog` DISABLE KEYS */;
/*!40000 ALTER TABLE `t_tackleoutlog` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `t_user_role` VALUES (1,1,1),(19,2,2),(20,4,2),(21,5,2),(28,2,3),(29,4,3),(30,5,3),(31,7,3),(78,7,4),(109,10,8),(110,10,9),(111,10,10),(112,10,11),(113,10,12),(115,10,14),(116,11,15),(117,2,7),(118,7,7),(119,9,7),(120,10,13),(121,12,13);
...
INSERT INTO `t_vaccine` VALUES (1,'2022-05-13 04:25:06','傅丽','小r','1eqweq'),(2,'2022-05-13 04:25:21','傅丽','小r','dadadasda');
...
-- Dump completed on 2023-02-25 15:09:17
